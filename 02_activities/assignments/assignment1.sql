...
SELECT c.customer_id, c.customer_first_name, c.customer_last_name, c.customer_postal_code,
...
SELECT customer_id, STRFTIME('%m', market_date) AS month, STRFTIME('%Y', market_date) AS year, SUM(quantity * cost_to_customer_per_qty) AS total_spend
FROM customer_purchases
